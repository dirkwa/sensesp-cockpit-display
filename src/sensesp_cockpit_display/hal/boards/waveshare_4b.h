...
/// Display driver for the Waveshare ESP32-P4-WIFI6-Touch-LCD-4B.
/// ST7703 panel controller, 720x720, 2-lane MIPI-DSI, RGB565.
class Waveshare4BDisplay : public DisplayDriver {
 public:
  static constexpr uint16_t kWidth = 720;
...
/// Touch driver for the GT911 on the Waveshare 4B board.
/// Uses Arduino Wire library on SDA=7, SCL=8 (same wiring as the 7B).
class Waveshare4BTouch : public TouchDriver {
 public:
  void init() override;
